        ...
        >
            ...
            <div className="flex justify-center items-center">
                <div className="flex justify-center items-center gap-2">
                    <Button text="Home" className="block mt-4 bg-gray-500 text-white font-semibold z-10" onClick={() =>handleHome()} />
                    <Button text="Play Again" className="block mt-4 bg-[#FF1C1C] text-white font-semibold z-10" onClick={() =>handlePlayAgain()} />
                </div>
                <div className="absolute bottom-36 flex justify-between items-center w-full px-2">
                    <img src="/images/rocket.png" alt="rocket" className="h-[150px]"/>
                    <img src="/images/rocket.png" alt="rocket" className="h-[150px]"/>
                </div>
            </div>
